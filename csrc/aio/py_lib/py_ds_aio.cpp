...
{
    m.def("deepspeed_aio_read", &deepspeed_py_aio_read, "DeepSpeed Asynchornous I/O Read");

    m.def("deepspeed_aio_write", &deepspeed_py_aio_write, "DeepSpeed Asynchornous I/O Write");
