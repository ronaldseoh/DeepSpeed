...
static void helper_memcpy_1(float *dest,
                            float *src,
                            size_t param_size)
{
...
static void helper_memcpy_4(float *dest,
                            float *src,
                            size_t param_size)
{
    size_t rounded_size = 0;
...
#endif
    if (param_size > rounded_size)
        helper_memcpy_1((dest + rounded_size),
                        (src + rounded_size),
                        (param_size - rounded_size));
}

static void helper_mempcy_8(float *dest,
                            float *src,
                            size_t param_size)
{
    size_t rounded_size = 0;
...
#endif
    if (param_size > rounded_size)
        helper_memcpy_4((dest + rounded_size),
                        (src + rounded_size),
                        (param_size - rounded_size));
}

int deepspeed_py_memcpy(torch::Tensor &dest,
